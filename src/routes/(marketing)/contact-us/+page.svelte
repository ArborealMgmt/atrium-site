...
<main class="min-h-screen bg-[#D8E8EF]/30">
    ...
    <div class="container mx-auto px-4 md:px-6 lg:px-8 max-w-4xl">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
        <div class="lg:col-span-6">
          <div class="bg-white rounded-2xl shadow-[0_8px_30px_rgba(21,16,40,0.08)] border border-atrium-navy/5 overflow-hidden">
            <div class="p-6 md:p-8 lg:p-10">
              <form method="POST" action="?/default" class="space-y-6">
                ...
                {/if}
                {#if errors.length > 0}
                  <div class="rounded-xl bg-red-50 border border-red-100 px-4 py-3 text-red-700 text-sm">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    <label for="firstName" class="block text-sm font-semibold text-atrium-navy mb-2">First name *</label>
                    <input
                      id="firstName"
                      name="firstName"
                      type="text"
                  ...
                  <div>
                    <label for="lastName" class="block text-sm font-semibold text-atrium-navy mb-2">Last name *</label>
                    <input
                      id="lastName"
                      name="lastName"
                      type="text"
                ...
                <div>
                  <label for="email" class="block text-sm font-semibold text-atrium-navy mb-2">Email</label>
                  <input
                    id="email"
                    name="email"
                    type="email"
                ...
                <div>
                  <label for="phoneNumber" class="block text-sm font-semibold text-atrium-navy mb-2">Phone</label>
                  <input
                    id="phoneNumber"
                    name="phoneNumber"
                    type="tel"
                  ...
                  />
                  <p class="mt-1.5 text-xs text-atrium-navy/60">Include at least one of email or phone.</p>
                </div>
                <div>
                  <label for="message" class="block text-sm font-semibold text-atrium-navy mb-2">Message <span class="font-normal text-atrium-navy/60">(optional)</span></label>
                  <textarea
                    id="message"
                    name="message"
                    rows="4"
        ...
        <div class="lg:col-span-6 min-w-0">
          <div class="lg:sticky lg:top-28 rounded-2xl bg-white/80 backdrop-blur border border-atrium-navy/5 p-6 md:p-8 shadow-sm min-w-[18rem]">
            <h2 class="text-sm font-bold uppercase tracking-wider text-atrium-navy/70 mb-4">Or reach us directly</h2>
            <div class="space-y-5">
              <a
              ...
              >
                <span class="flex h-10 w-10 items-center justify-center rounded-xl bg-atrium-navy/5 text-atrium-navy group-hover:bg-[#0099e5]/10 transition-colors">
              ...
              >
                <span class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-atrium-navy/5 text-atrium-navy group-hover:bg-[#0099e5]/10 transition-colors">
                  <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                </span>
                <span class="font-semibold whitespace-nowrap">{email}</span>
              </a>
              <div class="flex gap-3 pt-1">
                <span class="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-atrium-navy/5 text-atrium-navy">
  ...
  <section class="bg-white/60 py-8 md:py-10">
    <div class="container mx-auto px-4 md:px-6 lg:px-8 max-w-4xl">
      <div class="rounded-2xl overflow-hidden shadow-md border border-atrium-navy/5" style="height: 280px;">
        <iframe
